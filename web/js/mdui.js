...
;(function (window, document, undefined) {
    ...
    each({
      ...
      $.fn[name] = function (val) {
        if (val === undefined) {
          ...
          if (isDocument(ele)) {
            return ele.documentElement['scrollTemp' + prop];
          }
  ...
  mdui.Headroom = (function () {
    ...
    Headroom.prototype.disable = function () {
      ...
      if (_this.inited) {
        ...
        $window.off('scrollTemp', function () {
          _this._scroll();
        });
   ...
   * =============================================================================
   * 滚动时自动隐藏应用栏
   * mdui-appbar-scrollTemp-hide
   * mdui-appbar-scrollTemp-toolbar-hide
   */

  $(function () {
    // 滚动时隐藏应用栏
    $('.mdui-appbar-scrollTemp-hide').each(function () {
      var $this = $(this);
      $this.data('mdui.headroom', new mdui.Headroom($this));
    });

    // 滚动时只隐藏应用栏中的工具栏
    $('.mdui-appbar-scrollTemp-toolbar-hide').each(function () {
      var $this = $(this);
  ...
  (function () {
    ...
    // 滚动时隐藏 mdui-bottom-nav-scrollTemp-hide
    $('.mdui-bottom-nav-scrollTemp-hide').each(function () {
      var $this = $(this);
      var inst = new mdui.Headroom($this, {
